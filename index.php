...
<body class="home">
        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php">Obvious Store</a>
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="images/img/back.png">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Get products at your comfort </h1>
                    <h5 class="font-white space-xs">Find your shop, order and get free delivery</h5>
                    <div class="banner-form">
                        <form class="form-inline">
                            <button onclick="location.href='shop.php'" type="button" class="btn theme-btn btn-lg">Get My Products</button>
                        </form>
                    </div>
                    <div class="steps">
                        ...
                        <div class="step-item step2">
                            ...
                            <h4><span>2. </span>Order Products</h4> </div>
                        <!-- end:Step -->
