         ...
         <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
               <div class="container">
                  ...
                  <a class="navbar-brand" href="index.php">Thee Obvious Store</a>
               ...
               <div class="container">
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="panel">
                           <div class="panel-heading">
                              <h4 class="panel-title"><a data-parent="#accordion" data-toggle="collapse" class="panel-toggle" href="#faq2" aria-expanded="true"><i class="ti-info-alt" aria-hidden="true"></i>Can order and get products at your comfort</a></h4>
                           </div>
                           
                        </div>
                        <!-- end:Panel -->
                        <h4 class="m-t-20">Contact Customer Support</h4>
                        <p> for any questions email us </p>
                        <p> <a href="mailto:theeobviousstore@gmail.com" class="btn theme-btn m-t-15">Mail us</a> </p>
                     </div>
                     <!-- /WHY? -->
                  </div>
               </div>
